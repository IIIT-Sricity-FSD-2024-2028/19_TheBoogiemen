...
export const MOCK_USERS: USER[] = [
  {
    user_id: SEED.STUDENTS[0],
    username: 'alice_smith',
    email: 'alice@university.edu',
    role: 'student',
  },
  {
    user_id: SEED.STUDENTS[1],
    username: 'bob_jones',
    email: 'bob@university.edu',
    role: 'student',
  },
  {
    user_id: SEED.STUDENTS[2],
    username: 'charlie_brown',
    email: 'charlie@university.edu',
    role: 'student',
  },
  {
    user_id: SEED.FACULTY[0],
    username: 'dr_miller',
    email: 'miller@university.edu',
    role: 'faculty',
  },
  {
    user_id: SEED.FACULTY[1],
    username: 'dr_clark',
    email: 'clark@university.edu',
    role: 'faculty',
  },
  {
    user_id: SEED.ACADEMIC_HEADS[0],
    username: 'prof_taylor',
    email: 'taylor@university.edu',
    role: 'head',
  },
  {
    user_id: SEED.ADMINS[0],
    username: 'admin_sys',
...
export const MOCK_FACULTY: FACULTY[] = [
  ...
  {
    faculty_id: SEED.FACULTY[1],
    user_id: SEED.FACULTY[1],
    first_name: 'Emma',
    last_name: 'Clark',
    designation: 'Associate Professor',
    department_id: 'ME_DEPT',
  },
];
...
export const MOCK_COURSES: COURSE[] = [
  {
    ...
    completed_topics: 5,
    total_topics: 10,
    syllabus: ['Arrays', 'Lists', 'Trees', 'Graphs'],
  },
  {
...
export const MOCK_RESOURCES: RESOURCE[] = [
  {
    resource_id: SEED.RESOURCES[0],
    name: 'Lecture Hall A',
    capacity: 100,
    type: 'Classroom',
  },
  {
    resource_id: SEED.RESOURCES[1],
    name: 'Computer Lab 1',
    capacity: 40,
    type: 'Lab',
  },
...
export const MOCK_ASSESSMENTS: ASSESSMENT[] = [
  {
    assessment_id: SEED.ASSESSMENTS[0],
    course_id: SEED.COURSES[0],
    title: 'Midterm Exam',
    type: 'EXAM',
    max_marks: 100,
  ...
  {
    assessment_id: SEED.ASSESSMENTS[1],
    course_id: SEED.COURSES[0],
    title: 'Assignment 1',
    type: 'ASSIGNMENT',
    max_marks: 50,
...
export const MOCK_OUTCOMES: LEARNING_OUTCOME[] = [
  {
    outcome_id: SEED.OUTCOMES[0],
    course_id: SEED.COURSES[0],
    title: 'Understand basic data structures',
    description: 'Can implement arrays and lists.',
  },
];
...
export const MOCK_STUDENT_OUTCOMES: STUDENT_OUTCOME[] = [
  {
    ...
    student_id: SEED.STUDENTS[0],
    outcome_id: SEED.OUTCOMES[0],
    outcome_title: 'Understand basic data structures',
...
export const MOCK_FORUM_POSTS: FORUM_POST[] = [
  {
    id: post_1,
    topic_id: SEED.TOPICS[0],
    author_id: SEED.STUDENTS[0],
    content: 'Can anyone help with the Linked List assignment?',
...
export const MOCK_FORUM_REPLIES: FORUM_REPLY[] = [
  {
    id: reply_1,
    post_id: post_1,
    author_id: SEED.STUDENTS[2],
    content: 'Sure, I can help! Just traverse the nodes.',
